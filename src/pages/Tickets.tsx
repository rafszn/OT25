  ...
  return (
    <div className="my-10 mb-12">
      <div className="my-12 flex items-center justify-center">
        <div className="bg-white shadow-md rounded-2xl p-8 max-w-lg text-center border border-gray-200">
          <h1 className="text-2xl font-semibold text-gray-800 mb-4">
            Ticket Closed
          </h1>
          <p className="text-gray-600 leading-relaxed">
            Online ticket sales are now closed. <br />
            You can still purchase your ticket at the Event venue.
          </p>
        </div>
      </div>
    </div>
